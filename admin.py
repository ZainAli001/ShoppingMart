    ...
    def delete_emp(self):
        ...
        if len(self.sel) != 0:
            ...
            if sure == True:
                ...
                if flag == 1:
                    messagebox.showinfo(
                        "Success!!", "Employee deleted from database.", parent=emp)
                    self.sel.clear()
                    self.tree.delete(*self.tree.get_children())
                    self.DisplayData()
                else:
        ...
        if ename.strip():
            if valid_phone(econtact):
                if valid_Cnic_no(eaddhar):
                    ...
                    messagebox.showerror(
                        "Oops!", "Invalid Cnic number.", parent=e_add)
            else:
                messagebox.showerror(
