...
from admin import Inventory
from admin import Employee

root = Tk()

root.geometry("1366x768")
root.title("MZ MART EMPLOYEE")
...
def login(Event=None):
    ...
    if results:
        if results[0][6] == "SalesPerson":
            ...
            biller.mainloop()
        elif results[0][6] == "InventoryManager":
            messagebox.showinfo("Login Page", "The login is successful")
            page1.entry1.delete(0, END)
            page1.entry2.delete(0, END)
            root.withdraw()
            ...
            inv.mainloop()
        elif results[0][6] == "HiringManager":
            messagebox.showinfo("Login Page", "The login is successful")
            page1.entry1.delete(0, END)
            page1.entry2.delete(0, END)
            root.withdraw()
